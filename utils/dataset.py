...
class DVS_Lip(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print("self[0]:",self.file_list[0])

        # print("end of my test\n")
        ...
        # data augmentation
        if self.phase == 'train':
            event_voxel_low, event_voxel_high = RandomCrop(event_voxel_low, event_voxel_high, (8, 8)) #event_voxel_high, (88, 88)
            event_voxel_low, event_voxel_high = HorizontalFlip(event_voxel_low, event_voxel_high)
        else:
            event_voxel_low, event_voxel_high  = CenterCrop(event_voxel_low, event_voxel_high, (8, 8)) #event_voxel_high, (88, 88)
